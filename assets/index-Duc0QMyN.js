const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/SignupView-Dg5RTPdd.js","assets/SignupView-D0A4EQhh.css","assets/AboutView-CqdPKUV-.js","assets/AboutView-CSIvawM9.css","assets/DashboardView-tsvDwQjA.js","assets/DashboardView-BTpTszeO.css","assets/IngredientRecipesView-C2Ipf6bK.js","assets/IngredientRecipesView-CgMc-woh.css","assets/SearchByIngredientView-NsQotjN7.js","assets/SearchByIngredientView-uktT5QbK.css","assets/FavouritesView-iGOcJIxi.js","assets/FavouritesView-ByUU5Mao.css","assets/RecipeDetailsView-DkCijG5M.js","assets/RecipeDetailsView-DpYTWKpC.css","assets/ShoppingListView-CrbwbUW4.js","assets/ShoppingListView-CXm-guEn.css","assets/RestaurantDetailsView-BGadOvK8.js","assets/RestaurantDetailsView-CRAkOi7e.css","assets/SearchRestaurantByMealView-B4Sw9T6o.js","assets/SearchRestaurantByMealView-BYg9M7qq.css"])))=>i.map(i=>d[i]);
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Tt.DEFAULT_COLLECTION_PERCENTILE=10,Tt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Tt.DEFAULT=new Tt(Xm,Tt.DEFAULT_COLLECTION_PERCENTILE,Tt.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Tt.DISABLED=new Tt(-1,0,0);/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Oa{constructor(e,n,r){this.converter=n,this._query=r,this.type="query",this.firestore=e}withConverter(e){return new Oa(this.firestore,e,this._query)}}class At{constructor(e,n,r){this.converter=n,this._key=r,this.type="document",this.firestore=e}get _path(){return this._key.path}get id(){return this._key.path.lastSegment()}get path(){return this._key.path.canonicalString()}get parent(){return new Jn(this.firestore,this.converter,this._key.path.popLast())}withConverter(e){return new At(this.firestore,e,this._key)}}class Jn extends Oa{constructor(e,n,r){super(e,n,Xl(r)),this._path=r,this.type="collection"}get id(){return this._query.path.lastSegment()}get path(){return this._query.path.canonicalString()}get parent(){const e=this._path.popLast();return e.isEmpty()?null:new At(this.firestore,null,new te(e))}withConverter(e){return new Jn(this.firestore,e,this._path)}}function Fr(t,e,...n){if(t=We(t),R_("collection","path",e),t instanceof ka){const r=Oe.fromString(e,...n);return Nd(r),new Jn(t,null,r)}{if(!(t instanceof At||t instanceof Jn))throw new Z(U.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Oe.fromString(e,...n));return Nd(r),new Jn(t.firestore,null,r)}}function ur(t,e,...n){if(t=We(t),arguments.length===1&&(e=dm.newId()),R_("doc","path",e),t instanceof ka){const r=Oe.fromString(e,...n);return Dd(r),new At(t,null,new te(r))}{if(!(t instanceof At||t instanceof Jn))throw new Z(U.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");const r=t._path.child(Oe.fromString(e,...n));return Dd(r),new At(t.firestore,t instanceof Jn?t.converter:null,new te(r))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function mP(t,e,n=!1){const{auth:r}=t;if(It(r.app))return Promise.reject(bn(r));const s="reauthenticate";try{const i=await Ai(t,sy(r,s,e,t),n);se(i.idToken,r,"internal-error");const o=Ou(i.idToken);se(o,r,"internal-error");const{sub:c}=o;return se(t.uid===c,r,"user-mismatch"),Vr._forOperation(t,s,i)}catch(i){throw(i==null?void 0:i.code)==="auth/user-not-found"&&Bt(r,"user-mismatch"),i}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function iy(t,e,n=!1){if(It(t.app))return Promise.reject(bn(t));const r="signIn",s=await sy(t,r,e),i=await Vr._fromIdTokenResponse(t,r,s);return n||await t._updateCurrentUser(i.user),i}async function _P(t,e){return iy(dr(t),e)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function oy(t){const e=dr(t);e._getPasswordPolicyInternal()&&await e._updatePasswordPolicy()}async function yP(t,e,n){if(It(t.app))return Promise.reject(bn(t));const r=dr(t),o=await gl(r,{returnSecureToken:!0,email:e,password:n,clientType:"CLIENT_TYPE_WEB"},"signUpPassword",pP).catch(l=>{throw l.code==="auth/password-does-not-meet-requirements"&&oy(t),l}),c=await Vr._fromIdTokenResponse(r,"signIn",o);return await r._updateCurrentUser(c.user),c}function vP(t,e,n){return It(t.app)?Promise.reject(bn(t)):_P(We(t),Rs.credential(e,n)).catch(async r=>{throw r.code==="auth/password-does-not-meet-requirements"&&oy(t),r})}function EP(t,e,n,r){return We(t).onIdTokenChanged(e,n,r)}function TP(t,e,n){return We(t).beforeAuthStateChanged(e,n)}const ea="__sak";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
